...
<html class="no-js">
  ...
  <head>
    ...
    <link rel="stylesheet" href="home/cart/css/main.css" id="color-switcher-link" />
    <link rel="stylesheet" href="home/cart/css/animations.css" />
    <link rel="stylesheet" href="home/cart/css/fonts.css" />
    <script src="home/cart/js/vendor/modernizr-2.6.2.min.js"></script>
  ...
  <body>
    ...
    <div id="canvas">
      <div id="box_wrapper">
        ...
        <header
          class="page_header header_white floating_logo columns_padding_0 table_section"
        >
              ...
              <div class="col-md-3 col-xs-6">
                ...
                <span class="logo-meta">
                  ...
                  <a
                    ...
                    class="__cf_email__"
                    data-cfemail="afdcdadfdfc0dddbefccc0c2dfcec1d681ccc0c2"
                    >[email&#160;protected]</a
                  >
                </span>
              </div>
                  ...
                  <ul class="mainmenu nav sf-menu">
                    ...
                    <li>
                      ...
                      <ul>
                        <!-- features -->
                        <li>
                          <a href="shortcodes_teasers.html"
                            >Shortcodes&amp;Widgets</a
                          >
                          <ul>
                            <li>
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          <ul>
                            ...
                            <li>
                              <a href="gallery-regular-2-cols.html"
                                >2 columns</a
                              >
                            </li>
                            <li>
                            ...
                            <li>
                              <a href="gallery-regular-4-cols.html"
                                >4 columns</a
                              >
                            </li>
                          </ul>
                        ...
                        <li>
                          ...
                          <ul>
                            ...
                            <li>
                              <a href="gallery-fullwidth-3-cols.html"
                                >3 columns</a
                              >
                            </li>
                            <li>
                              <a href="gallery-fullwidth-4-cols.html"
                                >4 columns</a
                              >
                            </li>
                          </ul>
                        ...
                        <li>
                          ...
                          <ul>
                            ...
                            <li>
                              <a href="gallery-extended-2-cols.html"
                                >2 columns</a
                              >
                            </li>
                            <li>
                              <a href="gallery-extended-3-cols.html"
                                >3 columns</a
                              >
                            </li>
                          </ul>
                        ...
                        <li>
                          ...
                          <ul>
                            ...
                            <li>
                              <a href="gallery-carousel-2-cols.html"
                                >2 columns</a
                              >
                            </li>
                            <li>
                              <a href="gallery-carousel-3-cols.html"
                                >3 columns</a
                              >
                            </li>
                          </ul>
                ...
                <ul class="inline-dropdown inline-block">
                  <li class="dropdown login-dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="login">
                      <p>
                        <strong class="grey"
                          >If you have an account, please log in:</strong
                        >
                      </p>
                      <form
                        role="form"
                      ...
                      >
                        ...
                        <a href="register.html" class="theme_button color2"
                          >Register</a
                        >
                      </form>
                    ...
                    <div class="dropdown-menu" aria-labelledby="cart">
                      ...
                      <div class="widget widget_shopping_cart">
                        <div class="widget_shopping_cart_content">
                          <ul
                            class="cart_list product_list_widget media-list darklinks"
                          >
                            <li class="media">
                          ...
                          <p class="buttons">
                            <a
                              ...
                              >View All</a
                            >
                            <a href="checkout-right.html" class="theme_button"
                              >Checkout</a
                            >
                          </p>
                        </div>
        ...
        <section
          class="page_breadcrumbs ds ms parallax section_padding_bottom_30"
        >
          <div class="container">
            <div class="row">
              <div class="col-sm-12 text-center">
                ...
                <ol class="breadcrumb">
                  <li>
                    <a href="https://html.modernwebtemplates.com/">
                      HomePage
                    </a>
                  </li>
                  <li>
        ...
        <section
          class="ls ms section_padding_top_100 section_padding_bottom_75 columns_padding_25"
        >
          <div class="container">
            <div class="row">
              <div class="col-sm-7 col-md-8 col-lg-8">
                ...
                <div class="cart-buttons">
                  ...
                  <button type="submit" class="theme_button color2">
                    Proceed to Checkout
                  </button>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div
                      class="shipping-calculator-form with_padding muted_background"
                    >
                      ...
                      <div class="form-group">
                        <select
                          ...
                          class="country_to_state form-control"
                        >
                  ...
                  <div class="widget widget_price_filter">
                    ...
                    >
                      ...
                      <div class="form-group">
                        ...
                        <input
                          type="text"
                          class="slider_price_min form-control text-center"
                          id="slider_price_min"
                          readonly
                        />
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input
                          type="text"
                          class="slider_price_max form-control text-center"
                          id="slider_price_max"
                          readonly
                        />
                      </div>
                      ...
                      <div class="text-right">
                        <button
                          type="submit"
                          class="theme_button small_button color1"
                        >
                          Filter
                        </button>
                      </div>
                    ...
                    <ul class="media-list">
                      <li class="media">
                        ...
                        <div class="media-body">
                          <h3>
                            <a href="product-right.html"
                              >Rebum stet clita kasd lorem ipsum dolor</a
                            >
                          </h3>
                      ...
                      <li class="media">
                        ...
                        <div class="media-body">
                          <h3>
                            <a href="product-right.html"
                              >Rebum stet clita kasd sit amet</a
                            >
                          </h3>
        ...
        <footer
          class="page_footer ds ms section_padding_top_65 section_padding_bottom_50"
        >
          <div class="container">
            <div class="row">
              <div
                class="col-md-3 col-sm-6 to_animate"
                ...
                <div class="widget widget_text">
                  ...
                  <p>
                    <a
                      href="https://html.modernwebtemplates.com/cdn-cgi/l/email-protection"
                      class="__cf_email__"
                      data-cfemail="b2dbdcd4ddf2d1dddfc2d3dccb9cd1dddf"
                      >[email&#160;protected]</a
                    >
                  </p>
                  <p>www.company.com</p>
              ...
              >
                <div class="widget widget_mailchimp">
                  ...
                  <p>
                    Subscribe to our latest news to be updated, we promise not
                    to spam!
                  </p>

                  <form
                    class="signup form-inline"
                    action="https://html.modernwebtemplates.com/"
                    method="get"
                  >
                    <div class="form-group">
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 text-center text-sm-left">
                <p>
                  &copy; Solar 2015 | Created with
                  <i class="rt-icon2-heart highlight"></i> by MWTemplates
                </p>
              </div>
              <div
                class="col-sm-6 text-center text-sm-right to_animate"
                data-animation="scaleAppear"
              >
                <div class="big">
    ...
    ></script>
    <script src="cart/js/compressed.js"></script>
    <script src="cart/js/main.js"></script>
    <script src="cart/js/switcher.js"></script>
  </body>
</html>
